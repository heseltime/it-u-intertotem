...
def build_config() -> dict[str, str]:
    ...
    return dict(
        ...
        # Misc meson settings
        meson_backend="ninja",
        build_dir=r"/tmp/pip-wheel-n64pzfeg/contourpy_9f5ae64d90754cf0a90dede5cb4fae0d/.mesonpy-xwsugq_1/lib/contourpy/util",
        source_dir=r"/tmp/pip-wheel-n64pzfeg/contourpy_9f5ae64d90754cf0a90dede5cb4fae0d/lib/contourpy/util",
        cross_build="False",

        # Build options
        build_options=r"-Dbuildtype=release -Db_ndebug=if-release -Db_vscrt=md -Dvsenv=True --native-file=/tmp/pip-wheel-n64pzfeg/contourpy_9f5ae64d90754cf0a90dede5cb4fae0d/.mesonpy-xwsugq_1/meson-python-native-file.ini",
        buildtype="release",
        cpp_std="c++17",
        debug="False",
        optimization="3",
